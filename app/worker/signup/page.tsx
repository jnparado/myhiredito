    ...
    <AuthShell variant="worker" mode="signup">
      <form className="space-y-5" onSubmit={onSubmit}>
        ...
        <p className="text-center text-xs leading-5 text-zinc-400">
          Create your profile, add skills and credentials, then start applying.
        </p>
        ...
        <div className="rounded-lg border border-dashed border-zinc-300 bg-zinc-50 px-4 py-3 text-sm text-zinc-600">
          ...
          <p className="mt-1 text-xs text-zinc-500">
            Use the demo worker account on the{" "}
            <Link href="/worker/login" className="font-bold text-[#1db954] hover:underline">
              login page
            </Link>{" "}
            — no signup required.
          </p>
