...
export function EmployerOnboardingTaskList() {
  const { user, userKey, progress, loading } = useEmployerOnboarding();
      ...
      <div className="overflow-hidden rounded border border-emerald-200 bg-emerald-50 shadow-sm">
        <div className="flex items-center gap-2 px-4 py-3">
          ...
          <p className="text-sm font-semibold text-emerald-800">
            Onboarding complete — your business is verified and ready to post jobs.
          </p>
        </div>
      </div>
    );
