...
export function EmployerOnboardingStepLayout({
  stepId,
  title,
  description,
  children,
  ...
  return (
    <div className="mx-auto max-w-2xl px-3 py-6 sm:px-6 sm:py-8">
      ...
      <div className="mt-6 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
        ...
        Complete this step to verify your business and unlock job posting.
      </div>
...
export function EmployerOnboardingStepForm({ stepId, children }: SubmitProps) {
  const router = useRouter();
  const { user, userKey } = useEmployerOnboarding();
